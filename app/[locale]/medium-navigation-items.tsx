...
export default function MediumScreenNavigationBar({ children, pathGroups, bestMatch }: NavigationBarProps) {
  ...
  return (
    <div className="grid h-full w-full grid-cols-[auto_1fr] justify-center overflow-hidden">
      <motion.div className="relative flex h-full overflow-hidden border-r" variants={sidebarVariants} initial={sidebarVariants.closed} animate={isVisible ? 'open' : 'closed'}>
