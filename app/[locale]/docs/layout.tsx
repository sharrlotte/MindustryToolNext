    ...
    <div className="h-full relative w-full grid grid-rows-[auto_1fr] overflow-hidden">
      <div className="flex border-b p-4 items-center overflow-hidden h-16 gap-8 bg-card/80">
        ...
        <div className="flex items-center gap-4">
          <Link className="flex gap-2 items-center text-base hover:text-brand" href="/docs/wiki">
            Wiki
          </Link>
          <Link className="flex gap-2 items-center text-base hover:text-brand" href="/docs/api">
            Api
          </Link>
        </div>
        <DocSearchBar />
