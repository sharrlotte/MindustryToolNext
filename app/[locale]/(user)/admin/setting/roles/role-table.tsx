...
import { RoleList } from '@/app/[locale]/(user)/admin/setting/roles/role-list';
import { RoleListSkeleton } from '@/app/[locale]/(user)/admin/setting/roles/role-list-skeleton';
...
const CreateRoleDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/roles/create-role-dialog'));
