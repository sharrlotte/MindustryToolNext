...
import CreateGroupInfoDialog from '@/app/[locale]/(user)/admin/setting/tags/create-group-info-dialog';
import CreateTagCategoryDialog from '@/app/[locale]/(user)/admin/setting/tags/create-tag-category-dialog';
import CreateTagDialog from '@/app/[locale]/(user)/admin/setting/tags/create-tag-dialog';
import DeleteGroupInfoDialog from '@/app/[locale]/(user)/admin/setting/tags/delete-group-info-dialog';
...
const DeleteTagDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/tags/delete-tag-dialog'));
const UpdateTagDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/tags/update-tag-dialog'));

const DeleteTagCategoryDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/tags/delete-tag-category-dialog'));
const UpdateTagCategoryDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/tags/update-tag-category-dialog'));
