...
import CreateModDialog from '@/app/[locale]/(user)/admin/setting/mods/create-mod-dialog';
...
const DeleteModDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/mods/delete-mod-dialog'));
const UpdateModDialog = dynamic(() => import('@/app/[locale]/(user)/admin/setting/mods/update-mod-dialog'));
