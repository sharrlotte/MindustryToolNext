...
const PaginationParam = {
  size: z.coerce.number().gte(1).default(30).catch(30),
  page: z.coerce.number().gte(0).default(0).catch(0),
};
...
export const TranslationPaginationQuery = z.object({
  ...PaginationParam,
  language: z.enum(locales).default('en').catch('en'),
  target: z.enum(locales).default('vi').catch('vi'),
