...
export default function DislikeButton({ className, ...props }: LikeButtonProps) {
  ...
  return (
    <button
      className={cn('flex h-9 min-w-9 gap-2 text-lg items-center hover:border-destructive justify-center rounded-md overflow-hidden border-border border p-2 hover:bg-destructive hover:text-background dark:hover:text-foreground', className, {
