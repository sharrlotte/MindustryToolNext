...
function ModCard({ mod, value, onValueSelected }: ModCardProps) {
  return (
    <div
      className={cn('flex gap-1 rounded-full p-2 text-sm text-center items-center cursor-pointer justify-center border min-w-20 shrink-0 hover:bg-brand hover:text-brand-foreground', {
