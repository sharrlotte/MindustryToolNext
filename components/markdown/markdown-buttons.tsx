...
export function BoldButton({ callback }: Props) {
	return (
		<Button
			className="h-6 p-0 min-w-0 w-fit"
			size="icon"
			title="bold"
			variant="icon"
			type="button"
			onClick={() => callback((input, value) => wrapAtCaret(input, value, '**', '**'))}
		>
...
export function ItalicButton({ callback }: Props) {
	return (
		<Button
			className="h-6 p-0 min-w-0 w-auto"
			size="icon"
			title="bold"
			variant="icon"
			type="button"
...
export function HRButton({ callback }: Props) {
	return (
		<Button
			...
			variant="icon"
			type="button"
			onClick={() => callback((input, value) => insertAtCaret(input, value, '\n----------\n'))}
		>
			<HRIcon className="size-4" />
		</Button>
	);
}
...
export function OrderedListButton({ callback }: Props) {
	return (
		<Button
			...
			variant="icon"
			type="button"
			onClick={() => callback((input, value) => insertAtCaret(input, value, '1. '))}
		>
