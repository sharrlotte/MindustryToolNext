	...
	'inline-flex items-center gap-1 justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-70 text-nowrap',
	{
		variants: {
			variant: {
				...
				primary: 'bg-brand text-brand-foreground border border-brand',
				destructive: 'bg-destructive text-destructive-foreground shadow-sm hover:bg-opacity-90 border border-destructive',
				...
				toggled: 'bg-secondary border border-secondary flex items-center gap-2 w-full justify-start',
				toggle: 'hover:bg-secondary border border-transparent flex items-center gap-2 w-full justify-start',
				...
				'command-destructive': 'justify-between gap-1 hover:bg-destructive rounded-sm p-0 text-destructive-foreground w-full',
			},
			size: {
