...
const buttonVariants = cva('relative flex cursor-pointer select-none items-center gap-1 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50', {
  variants: {
    variant: {
      default: '',
...
>(({ className, variant, inset, ...props }, ref) => <ContextMenuPrimitive.Item ref={ref} className={cn(buttonVariants({ variant, className }), inset && 'pl-8', className)} {...props} />);
