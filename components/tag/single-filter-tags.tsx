	...
	return (
		<div className="flex w-full flex-wrap justify-start py-2 gap-1">
			...
			{group.values.map((value) => (
				<button
					className={cn(
						'capitalize flex hover:scale-105 transition-all bg-secondary border overflow-hidden border-border gap-1 hover:bg-brand hover:text-brand-foreground text-muted-foreground data-[state=on]:bg-brand data-[state=on]:text-brand-foreground px-2 py-2 rounded-lg hover:border-brand',
						{
