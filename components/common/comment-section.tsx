          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormControl>
                  <AutosizeTextarea
                    className="focus-visible:outline-hidden border-transparent focus-visible:ring-transparent border-transparent focus-visible:border-transparent resize-none"
