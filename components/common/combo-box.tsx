  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button className={cn('w-[200px] gap-2 items-center border border-border justify-between capitalize shadow-md', className)} title={value?.label?.toLowerCase() || placeholder} aria-label="combobox" role="combobox" variant="outline">
