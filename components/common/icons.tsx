...
export const BoxIcon = ({ className }: Props) => <Box className={className ?? 'lucide'} />;
export const CommentIcon = ({ className }: Props) => <MessageSquareIcon className={className ?? 'lucide'} />;
export const AlertTriangleIcon = ({ className }: Props) => <AlertTriangle className={className ?? 'lucide'} />;
export const AnalyticIcon = ({ className }: Props) => <LineChart className={className ?? 'lucide'} />;
export const XCircleIcon = ({ className }: Props) => <XCircle className={className ?? 'lucide'} />;
export const CheckCircleIcon = ({ className }: Props) => <CheckCircle className={className ?? 'lucide'} />;
export const BackIcon = ({ className }: Props) => <ArrowLeft className={className ?? 'lucide'} />;
export const SunIcon = ({ className }: Props) => <Sun className={className ?? 'lucide'} />;
export const MoonIcon = ({ className }: Props) => <Moon className={className ?? 'lucide'} />;
export const ExternalLinkIcon = ({ className }: Props) => <ExternalLink className={className ?? 'lucide'} />;
export const DislikeIcon = ({ className }: Props) => <ThumbsDown className={className ?? 'lucide'} />;
export const LikeIcon = ({ className }: Props) => <ThumbsUp className={className ?? 'lucide'} />;
export const FolderIcon = ({ className }: Props) => <Folder className={className ?? 'lucide'} />;
export const ChevronRightIcon = ({ className }: Props) => <ChevronRight className={className ?? 'lucide'} />;
export const ChevronLeftIcon = ({ className }: Props) => <ChevronLeft className={className ?? 'lucide'} />;
export const LayoutListIcon = ({ className }: Props) => <List className={className ?? 'lucide'} />;
export const LayoutGridIcon = ({ className }: Props) => <LayoutGrid className={className ?? 'lucide'} />;
export const ArrowUpDownIcon = ({ className }: Props) => <ArrowUpDown className={className ?? 'lucide'} />;
export const CheckIcon = ({ className }: Props) => <Check className={className ?? 'lucide'} />;
export const ArrowLeftCircleIcon = ({ className }: Props) => <ArrowLeftCircle className={className ?? 'lucide'} />;
export const FilterIcon = ({ className }: Props) => <Filter className={className ?? 'lucide'} />;
export const GanttChartIcon = ({ className }: Props) => <GanttChart className={className ?? 'lucide'} />;
export const LogoutIcon = ({ className }: Props) => <LogOut className={className ?? 'lucide'} />;
export const SquareIcon = ({ className }: Props) => <Square className={className ?? 'lucide'} />;
export const SquareCheckedIcon = ({ className }: Props) => <CheckSquare2 className={className ?? 'lucide'} />;
export const GlobIcon = ({ className }: Props) => <Globe className={className ?? 'lucide'} />;
export const LinkIcon = ({ className }: Props) => <Link className={className ?? 'lucide'} />;
export const PostIcon = ({ className }: Props) => <BookOpenIcon className={className ?? 'lucide'} />;
export const MindustryGptIcon = ({ className }: Props) => <BotIcon className={className ?? 'lucide'} />;
export const FileIcon = ({ className }: Props) => <File className={className ?? 'lucide'} />;
export const DocumentIcon = ({ className }: Props) => <Folder className={className ?? 'lucide'} />;
export const HomeIcon = ({ className }: Props) => <Home className={className ?? 'lucide'} />;
export const MapIcon = ({ className }: Props) => <Map className={className ?? 'lucide'} />;
export const ServerIcon = ({ className }: Props) => <Server className={className ?? 'lucide'} />;
export const VerifyIcon = ({ className }: Props) => <ShieldCheckIcon className={className ?? 'lucide'} />;
export const UserIcon = ({ className }: Props) => <User className={className ?? 'lucide'} />;
export const ChartIcon = ({ className }: Props) => <SquareKanbanIcon className={className ?? 'lucide'} />;
export const ChatIcon = ({ className }: Props) => <MessageCircleIcon className={className ?? 'lucide'} />;
export const LogIcon = ({ className }: Props) => <HistoryIcon className={className ?? 'lucide'} />;
export const SchematicIcon = ({ className }: Props) => <ClipboardList className={className ?? 'lucide'} />;
export const SettingIcon = ({ className }: Props) => <SettingsIcon className={className ?? 'lucide'} />;
export const RoleIcon = ({ className }: Props) => <Users className={className ?? 'lucide'} />;
export const CmdIcon = ({ className }: Props) => <TerminalIcon className={className ?? 'lucide'} />;
export const PluginIcon = ({ className }: Props) => <Plug className={className ?? 'lucide'} />;
export const WarningIcon = ({ className }: Props) => <AlertCircle className={className ?? 'lucide'} />;
export const EllipsisIcon = ({ className }: Props) => <DotsHorizontalIcon className={className ?? 'lucide'} />;
export const NotificationIcon = ({ className }: Props) => <BellIcon className={className ?? 'lucide'} />;
export const GithubIcon = ({ className }: Props) => <Github className={className ?? 'lucide'} />;
...
export const UsersIcon = ({ className }: Props) => <Users className={className ?? 'lucide'} />;
export const PaperclipIcon = ({ className }: Props) => <Paperclip className={className ?? 'lucide'} />;
export const SmileIcon = ({ className }: Props) => <Smile className={className ?? 'lucide'} />;
export const SearchIcon = ({ className }: Props) => <Search className={className ?? 'lucide'} />;
export const SendIcon = ({ className }: Props) => <Send className={className ?? 'lucide'} />;
export const EditIcon = ({ className }: Props) => <Pencil className={className ?? 'lucide'} />;
export const RatioIcon = ({ className }: Props) => <Sigma className={className ?? 'lucide'} />;
export const XIcon = ({ className }: Props) => <X className={className ?? 'lucide'} />;
...
export function GrafanaIcon({ className }: Props) {
	return (
		<svg className={cn(className)} viewBox="0 0 128 128">
			<linearGradient
				id="a"
				x1="45.842"
				x2="45.842"
